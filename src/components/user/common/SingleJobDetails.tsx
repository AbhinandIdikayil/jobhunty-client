                ...
                <div className="flex w-full gap-5 px-20 justify-between p-6 bg-white  border-zinc-200 max-md:flex-wrap max-md:px-5">
                    <div className="flex gap-5 justify-center max-md:flex-wrap">
                        ...
                        <div className="flex flex-col my-auto">
                            <div className="text-lg sm:text-3xl font-semibold leading-10 text-slate-800">
                        ...
                        <div className="flex gap-5 max-md:flex-col">
                            <div className="flex flex-col w-[67%] max-md:ml-0 max-md:w-full">
                                <div className="flex flex-col text-base leading-6 text-slate-600 max-md:mt-10 max-md:max-w-full">
                                    <div className="text-lg sm:text-3xl font-semibold leading-10 text-slate-800 max-md:max-w-full">
                                        Description
                                    </div>
                                    ...
                                    <div className="mt-10 text-lg sm:text-3xl font-semibold leading-10 text-slate-800 max-md:max-w-full">
                                        Responsibilities
                                    </div>
                                    ...
                                    <div className="flex gap-2 mt-2 leading-7 ">
                                        <img
                                            loading="lazy"
                            ...
                            <div className="flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full">
                                <div className="flex flex-col grow max-md:mt-10">
                                    ...
                                    <div className="mt-10 text-lg sm:text-3xl font-semibold leading-10 text-slate-800">
                                        Categories
                                    </div>
